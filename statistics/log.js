...
module.exports = {object, log, getShortNumber, getArtboard, getAllArtboards, getCenterPoint, getBoundsInParent, getClassName, getFunctionName, 
  ...
  isInEditContext, isSiblingNode, isDescendantNode, isChildNode, isPortrait, isLandscape, getChildNodes, moveTo, sleep,
  centerLeft, center, centerRight, topLeft, topCenter, top, topRight, bottomLeft, bottom, bottomCenter, bottomRight, left, right,
  anchorToEdges, anchorToVerticalEdges, getArrayBufferFromSceneNode, getBase64FromSceneNode, anchorToHorizontalEdges, centerHorizontally, centerVertically, indentMultiline, toggleLayerVisibility, getTempImageFromSceneNode};